    ...
    <div class="row" style="max-height: 50rem;"> 
        <div class="col-sm-5">
            <div class="card" style="max-height: 100rem;">
                <div class="card-header bg-transparent border-success">Formulaire de modification des compteurs</div>
                    <div class="card-body">
                        <form action="/updated/{{$compteurs->id}}" method="POST">
                        {{ csrf_field() }}
                            <div class="form-group">
                                <label class="control-label" for="numero">Numero</label>
                                <input type="text" require type="text" name="numero" class="form-control" id="numero" >
                            </div>
                            <div class="form-group">
