        ...
        <div class="col-sm-5">
            <div class="card" style="max-height: 100rem;">
                <div class="card-header bg-transparent border-success">Formulaire des factures</div>
                    <div class="card-body">
                        <form action="/updatedd/{{$factures->id}}" method="POST">
                        {{ csrf_field() }}
                            <div class="form-group">
                                <label class="control-label" for="mois">mois</label>
                                <input type="text" require  name="mois" class="form-control" id="mois" >
                            </div>
                            <div class="form-group">
                                <input type="checkbox" class="form-check-input" id="reglement" value=1>
                                <label class="form-check-label" for="reglement">Reglementer?</label>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-success" name="ajouter" id="ajouter" value="Modifier"/>
